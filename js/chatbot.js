// Chatbot for Uday's Portfolio Website
...
const chatbotConfig = {
    ...
    welcomeMessage: {
        hindi: "नमस्ते! मैं उदय का AI असिस्टेंट हूँ। मैं आपको उदय के तकनीकी कौशल, प्रोजेक्ट्स, या संपर्क जानकारी के बारे में बता सकता हूँ। मैं आपकी कैसे मदद कर सकता हूँ?",
        english: "Hello! I'm Uday's AI Assistant. I can help you learn about Uday's technical expertise, projects, or connect you with him. How can I assist you today?"
    },
    placeholderText: {
    ...
    suggestions: {
        hindi: [
            "उदय के बारे में बताएं",
            "उदय के कौशल क्या हैं?",
            "पोर्टफोलियो प्रोजेक्ट्स दिखाएं",
            "संपर्क जानकारी"
        ],
        english: [
            "Tell me about Uday",
            "What are Uday's skills?",
...
const knowledgeBase = {
    about: {
        keywords: ["about", "who", "उदय", "कौन", "बारे में", "परिचय", "introduction"],
        response: {
            hindi: "उदय प्रताप एक तकनीकी पेशेवर हैं जिन्हें MS Office सुइट, Power BI के साथ डेटा विज़ुअलाइज़ेशन और कंप्यूटर ऑपरेशंस में विशेषज्ञता है। वे वेब डेवलपमेंट और AI-संचालित समाधानों में भी कुशल हैं, जहां वे उपयोगकर्ता-अनुकूल वेबसाइटें और Android एप्लिकेशन बनाते हैं।",
            english: "Uday Pratap is a tech professional with expertise in MS Office suite, data visualization with Power BI, and computer operations. He is also skilled in web development and AI-powered solutions, where he creates user-friendly websites and Android applications."
        }
    },
    skills: {
        keywords: ["skills", "कौशल", "expertise", "specialization", "विशेषज्ञता", "क्या कर सकते हैं"],
        response: {
            hindi: "उदय के प्रमुख कौशल हैं: MS Office Suite (95%), Power BI (85%), HTML/CSS (90%), JavaScript (75%), संचार (85%), टीमवर्क (90%), समस्या समाधान (80%), और रचनात्मकता (95%)।",
            english: "Uday's key skills include: MS Office Suite (95%), Power BI (85%), HTML/CSS (90%), JavaScript (75%), Communication (85%), Teamwork (90%), Problem Solving (80%), and Creativity (95%)."
        }
    },
    portfolio: {
        keywords: ["portfolio", "projects", "work", "पोर्टफोलियो", "प्रोजेक्ट", "काम", "परियोजनाएं"],
        response: {
            hindi: "उदय के प्रमुख प्रोजेक्ट्स हैं: NSTI कॉलेज कानपुर के लिए लीव मैनेजमेंट सिस्टम, कॉर्पोरेट डैशबोर्ड (Power BI), इन्वेंटरी मैनेजमेंट ऐप, AI-पावर्ड चैटबॉट, सेल्स एनालिसिस रिपोर्ट, और ई-लर्निंग प्लेटफॉर्म।",
            english: "Uday's key projects include: Leave Management System for NSTI College Kanpur, Corporate Dashboard (Power BI), Inventory Management App, AI-Powered Chatbot, Sales Analysis Report, and E-Learning Platform."
        }
    },
    contact: {
        keywords: ["contact", "email", "phone", "संपर्क", "ईमेल", "फोन", "संपर्क करें", "बात करें"],
        response: {
            hindi: "आप उदय से ईमेल: uday1122pratap@gmail.com या फोन: +91 9264956210 पर संपर्क कर सकते हैं। वे भारत में स्थित हैं।",
            english: "You can contact Uday via email: uday1122pratap@gmail.com or phone: +91 9264956210. He is located in India."
        }
    },
    default: {
        response: {
            hindi: "मुझे आपका प्रश्न समझ नहीं आया। क्या आप उदय के बारे में, उनके कौशल, पोर्टफोलियो या संपर्क जानकारी के बारे में जानना चाहते हैं?",
            english: "I didn't understand your question. Would you like to know about Uday, his skills, portfolio, or contact information?"
        }
    }
};
